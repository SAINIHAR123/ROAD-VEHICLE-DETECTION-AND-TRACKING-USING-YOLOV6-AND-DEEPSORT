...
def vehicleDetection():
    ...
    saved_model_loaded = tf.saved_model.load('checkpoints/yolov6-416', tags=[tag_constants.SERVING])
...
font1 = ('times', 14, 'bold')
upload = Button(main, text="Generate & Load YOLOv6-DeepSort Model", command=loadModel)
...
markovButton = Button(main, text="Upload Video & Detect Car & Truck", command=vehicleDetection)
